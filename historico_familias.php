    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Gestión Historico Familias de Productos</strong>
            </li>
        </ol>
    </div>
                ...
                <div class="ibox-content">
                    <div class="clients-list">
                        <ul class="nav nav-tabs">
                            <li><a class="nav-link active" data-toggle="tab" href="#tab-1"><i class="fa fa-sitemap"></i> HISTORICO FAMILIAS PRODUCTOS</a></li>
