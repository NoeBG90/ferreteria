...
$conexio =   conectar_bd();
$query = "SELECT id_compra, p.nombre as id_proveedor, fecha_compra, folio_compra, folio_factura, e.nombre as id_empleado,
total, c.estatus, c.fecha_registro, c.fecha_actualizacion, subtotal, iva_monto, iva_porcentual 
FROM compras c, empleados e ,proveedores p 
where c.id_empleado =e.id_empleado  and c.id_proveedor =p.id_proveedor order by c.id_compra ";
