                                ...
                                <div class="row align-items-center">
                                    <div class="col-12 col-md-7">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-barcode" id="productoid" name="productoid" maxlength="70" placeholder="SKU ó Producto">
                                        </div>
                                    </div>
                        ...
                        <div class="col-12 col-lg-4">
                            ...
                            <form id="frmcompra" name="frmcompra" role="form">
                                <div class="form-group row align-items-center">
                                    <label class="col-4 text-left">Empleado</label>
                                    <input type="hidden" name="hddide" id="hddide" value="<?php echo $_SESSION['idempleado']; ?>">
                                    <input class="col-8 text-left" type="text" name="capturo_compra" id="capturo_compra" value="<?php echo $_SESSION['Nombre'] . "-" . $_SESSION['Puesto']; ?>" disabled>
                                </div>
                                <div class="form-group row align-items-center">
                                    <label class="col-4 text-left">Folio Factura</label>
                                    <input class="col-8 text-center" type="text" name="txtfolio_factura" id="txtfolio_factura" placeholder="E4GXXXXX-XXXX-XXXX-XXXX-XXXXXXXX">
                                </div>
                                <div class="form-group row align-items-center">
                                    <label class="col-4 text-left">Fecha</label>
                                    <input class="col-8 text-center" type="text" name="txtfecha_compra" id="txtfecha_compra">
                                </div>
                                <div class="form-group row align-items-center">
                                    <label for="compra_proveedor" class="col-4 text-left">Proveedor</label>
                                    <select name="slsproveedor" id="slsproveedor" class="col-8 text-right">
                                        <option value="">*</option>
                                        <?php
