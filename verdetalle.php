...
$pdf->Cell(0, 7, iconv('utf-8', 'cp1252', 'Folio de compra: ' . $folio_compra), 0, 1, 'R');
$pdf->Cell(0, 7, iconv('utf-8', 'cp1252', 'Factura: ' . $folio_factura), 0, 1, 'R');
$pdf->Cell(0, 7, iconv('utf-8', 'cp1252', 'Capturó: ' . $empleado), 0, 1, 'R');
$pdf->Cell(0, 7, iconv('utf-8', 'cp1252', 'Proveedor: ' . $proveedor), 0, 1, 'R');
