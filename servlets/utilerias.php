    ...
    $_SESSION['cotizacion_edit']['tabla'] .=
      "<tr class='cotizacion' id='" . $i . "'>
          ...
          <td >
            ...
            <input type='text' class='inputEdit cantidades col-11 text-center focusNext' name='txtcantidad'  id='txtcantidad" . $i . "'     value='" . $_SESSION['cotizacion_edit']['productos'][$i]->stok . "'         ></td>
