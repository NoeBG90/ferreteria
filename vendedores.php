...
include "conexion/conexion.php";
        $conexio=   conectar_bd();
        $query="select * from empleados where estatus='Activo' order by puesto";
...
<div class="row wrapper border-bottom white-bg page-heading">
    ...
    <div class="clients-list">
        <ul class="nav nav-tabs">
            <li><a class="nav-link active" data-toggle="tab" href="#tab-1"><i class="fa fa-id-card-o"></i> EMPLEADOS</a></li>
...
<script type="text/javascript">
    localStorage.setItem("pagina","vendedores");
</script>
<?php
    include "footer.php";
?>
