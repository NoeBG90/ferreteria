...
include "conexion/conexion.php";
        $conexio=   conectar_bd();
        $query="SELECT c.*,e.nombre vendedor FROM clientes c, empleados e WHERE c.id_empleado=e.id_empleado  AND  puesto='Vendedor' and c.estatus='Inactivo'";
                ...
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Histórico Clientes</strong>
                        </li>
                    </ol>
                </div>
                    ...
                    <div class="ibox">
                        <div class="ibox-content">
                            ...
                            <ul class="nav nav-tabs">
                                <li><a class="nav-link active" data-toggle="tab" href="#tab-1"><i class="fa fa-group (alias)"></i>HISTÓRICO CLIENTES</a></li>
                            </ul>
...
<script type="text/javascript">
    localStorage.setItem("pagina","historico_clientes");
</script>
<?php
    include "footer.php";
?>
