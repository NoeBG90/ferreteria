                        ...
                        <div class="col-12 col-lg-4">
                            ...
                            <form id="frmregistrocotizaciones_edicion" name="frmregistrocotizaciones_edicion">
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <input class="col-sm-7 text-center" type="text" name="txtvigenciacot" id="txtvigenciacot" placeholder="30 días despues de la fecha de hoy(cotizacion)" value="<?php echo $vigencia; ?>">
                                </div>
                                <div class="form-group row align-items-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group d-flex justify-content-between">
                                        ...
                                        <div class="form-check form-check-inline">
                                            ...
                                            <label class="form-check-label text-secondary" for="rbtncredito"><i class="fa fa-dollar"></i> Crédito</label>
                                        </div>
                                        <div class="form-check form-check-inline">
