...
$montodeudor=$fila['total']-$monto_abono['abono']; 
                   ...
                   <div class="form-group row align-items-center">
                    ...
                    <form id="frmabonosventa" name="frmabonosventa" class="col-lg-8" style="width: 100%; border-radius: 23rem;" >
                        ...
                        <div class="form-group row align-items-center">
                            ...
                            Saldo Inicial $</label>
                            <input class="col-sm-5" type="text" name="textabonoiventa" id="textabonoiventa" readonly="true" value="<?php echo $montodeudor;?>"
                            style="border: none; color: green; font-size: 24px; font-weight: bold;">
                        </div>
