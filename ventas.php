                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group">
                                                        <button id="abonar<?php echo $fila['id_operacion']; ?>" name="abonar<?php echo $fila['id_operacion']; ?>"
                                                            class="btnabonar btn btn-warning dim" value="<?php echo $fila['id_operacion']; ?>" type="button" data-toggle="tooltip" data-placement="top" title="Abonar"><i class="fa fa-calculator"></i></button>
                                                        <button id="movimiento<?php echo $fila['id_operacion']; ?>" name="movimiento<?php echo $fila['id_operacion']; ?>" class="btnmovimiento btn btn-primary dim" 
                                                        value="<?php echo $fila['id_operacion']; ?>" type="button" data-toggle="tooltip" data-placement="top" title="Movimientos"><i class="fa fa-table"></i></button>

                                                        
                                                        <!--<a href="editar_cotizacion.php?id_cotizacion=<?php //echo $fila['id_operacion'];?>" class="btn-white btn btn-xs">Editar</a>-->
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php
