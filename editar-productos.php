                        ...
                        <div class="ibox-content">
                            <form name="frmeditarproductos" id="frmeditarproductos" action="servlets/guardar_compra.php" method="post" enctype="multipart/form-data">
                                <div class="form-group  row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" name="txtnumproducto" id="txtnumproducto" class="form-control" value="<?php echo $fila['numero_producto']; ?>" disabled></div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" name="txtstock" id="txtstock" class="form-control" placeholder="50" value="<?php echo $fila['stok']; ?>">
                                    </div>
                                 ...
                                 <div class="form-group  row">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="slsumedida" id="slsumedida"  class="form-control">
                                            <option value="">*</option>
                                            <option value="Pzs" <?php if($fila['unidad_medida']=="Pzs"){ echo 'selected="selected"';} ?> >Pzs</option>
                                            <option value="Mts" <?php if($fila['unidad_medida']=="Mts"){ echo 'selected="selected"';} ?>>Mts</option>
                                            <option value="Lts" <?php if($fila['unidad_medida']=="Lts"){ echo 'selected="selected"';} ?> >Lts</option>
                                            <option value="Kgs" <?php if($fila['unidad_medida']=="Kgs"){ echo 'selected="selected"';} ?>>Kgs</option>
                                            <option value="Caja" <?php if($fila['unidad_medida']=="Caja"){ echo 'selected="selected"';} ?>>Caja</option>
                                        </select>
                                    </div>
