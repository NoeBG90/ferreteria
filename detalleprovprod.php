...
<body class="">
    ...
    $conexio =   conectar_bd();
    $query = "SELECT folio_compra,folio_factura,e.nombre as 'empleado', p2.nombre as 'proveedor',c.fecha_compra ,c.fecha_registro , p.codigo_producto, p.producto ,p.SKU ,dc.cantidad ,dc.precio_compra from compras c , detalle_compras dc, productos p , proveedores p2, empleados e WHERE dc.id_producto =p.id_producto and dc.id_compra =c.id_compra and c.id_empleado =e.id_empleado and c.id_proveedor =p2.id_proveedor and p.id_producto = " . $_GET['id_producto'] . " order by c.fecha_registro desc limit 3;";
    $result = $conexio->query($query);

    $queryProducto = "SELECT p.codigo_producto, p.producto ,p.SKU  from productos p WHERE  p.id_producto = " . $_GET['id_producto'] . " ;";
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group  row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="txtnumproducto" id="txtnumproducto" class="form-control" value="<?php echo $filaProd['codigo_producto']; ?>" disabled>
                        </div>
                    </div>
                    <div class="form-group  row">
