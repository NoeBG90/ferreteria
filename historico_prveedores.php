...
include "conexion/conexion.php";
        $conexio=   conectar_bd();
        $query="SELECT * FROM proveedores where estatus='Inactivo'";
    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Histórico Proveedores</strong>
            </li>
        </ol>
    </div>
                ...
                <div class="ibox-content">
                    <div class="clients-list">
                        <ul class="nav nav-tabs">
                            <li><a class="nav-link active" data-toggle="tab" href="#tab-1"><i class="fa fa-suitcase"></i>HISTÓRICO PROVEEDORES</a></li>
                        </ul>
...
<script type="text/javascript">
    localStorage.setItem("pagina","historico_prveedores");
</script>
<?php
    include "footer.php";
?>
