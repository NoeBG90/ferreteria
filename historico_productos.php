...
$conexio =   conectar_bd();
$query = "SELECT p.*,fp.familia FROM productos p, familia_producto fp WHERE p.id_familia=fp.id_familia and imagen_producto !='' and p.estatus='Inactivo';";
    ...
    <div class="col-lg-10">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">
                <strong>Histórico de Productos</strong>
            </li>
        </ol>
    </div>
                ...
                <div class="ibox-content">
                    <div class="clients-list">
                        <ul class="nav nav-tabs">
                            <li><a class="nav-link active" data-toggle="tab" href="#tab-1"><i class="fa fa-cubes"></i> HISTÓRICO DE PRODUCTOS</a></li>
                        </ul>
...
<script type="text/javascript">
    localStorage.setItem("pagina", "historico_productos");
</script>
<?php
include "footer.php";
?>