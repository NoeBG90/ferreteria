...
<script>
    $(document).ready(function() {
        $('#frmregistroproductoscomp').validate({
            rules: {
                txtproducto: {
                    ...
                    remote: {
                        type: 'POST',
                        url: "servlets/checkproducto.php"
                    }
                },
                slsfamiliacomp: {
                    required: true
            ...
            messages: {
                txtproducto: {
                    ...
                    remote: "Prodcuto ya registrado"
                },
                slsfamiliacomp: {
                    required: "Seleccione la familia del producto"
                },
                txtSKUcomp: {
                    required: "Ingrese codigo SKU producto"
                },
                txtmarcacomp: {
                ...
                slsstatuscomp: {
                    required: "Seleccione el estatus del producto"
                },
                textadescripcioncomp: {
                    required: "Ingrese descripción del producto"
                },
                slsumedida: {
                    required: "Seleccione la unidad de medida para el nuevo producto"
                }
            }
        ...
        $('#textabonoventa').keyup(function() {
            let inicial = $('#textabonoiventa').val();
            let abono = $(this).val();
