                ...
                <div class="col-lg-12">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">
                            <strong>Registrar Pedido por Cotización</strong>
                        </li>
                    </ol>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                   <div class="form-group row align-items-center">
                    ...
                    <hr>
                    <form id="frmregistrarpedidocot" name="frmregistrarpedidocot">
                        <div class="form-group row align-items-center">
                            <label class="col-sm-3 text-left">Folio Pedido</label>
                            <input class="col-sm-9 text-center" type="text" name="txtfolio_pedidocot" id="txtfolio_pedidocot" disabled placeholder="PE001-SARS">
                        </div>
                        <div class="form-group row align-items-center">
                            <label class="col-sm-4 text-left">Fecha Solicitud</label>
                            <input class="col-sm-8 text-center" type="text" name="txtfecha_pedidocot" id="txtfecha_pedidocot">
                        </div>

                        <div class="form-group row align-items-center">
                            <label class="col-sm-3 text-left">Atención</label>
                            <input type="hidden" name="ide" value="<?php echo $_GET['ide'];?>">
                            <input class="col-sm-9 text-left" type="text" name="txtcapturopedido" id="txtcapturopedido" value="<?php echo $_SESSION['Nombre']."-".$_SESSION['Puesto'];?>" disabled>
                        </div>
                        <hr>
                        <div class="form-group row align-items-center">
