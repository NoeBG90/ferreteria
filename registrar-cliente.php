                        ...
                        <div class="ibox-content">
                            <form id="formregistroclientes" name="formregistroclientes">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2">
                                        <input type="text" id="txtciudad" name="txtciudad" placeholder="México" readonly class="form-control">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">Estado</label>
                                    <div class="col-sm-4">
                                        <input type="text" id="txtedo" name="txtedo" placeholder="Estado de México" readonly class="form-control">
                                    </div>
                                    <!--<label class="col-sm-2 col-form-label">País</label>
                                    <div class="col-sm-4">
                                        <input type="text" id="txtpais" name="txtpais" placeholder="México" class="form-control">
                                    </div>-->
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="text" id="txtdescuento" name="txtdescuento" placeholder="10%" class="form-control"></div>
